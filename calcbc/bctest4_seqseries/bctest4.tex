...
\example{Determine if the series $\displaystyle \sum_{n=1}^\infty \frac{(-1)^{n+1}n^2}{(n+1)^2}$ is absolutely convergent, conditionally convergent, or divergent.}

By the $n$th-term test, the series \fbox{diverges}.
